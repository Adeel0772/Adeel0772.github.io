...
//Start - MUZZAMMIL - 20-Mar-2023
//Added function to display name and cnic.
function name_cnic_link($row) {
	$sales_header = get_sales_order_header($row['order_no'], ST_SALESORDER);
	return $sales_header['cust_name'] ? $sales_header['cust_name'] . ' / ' . $sales_header['cust_cnic'] : '';
}
//End - MUZZAMMIL - 20-Mar-2023
...
if ($trans_type == ST_SALESORDER)
	$cols = array(
		...
		//Start - MUZZAMMIL - 20-Mar-2023
		//Changed Branch Name to Customer Name /Cnic to display walkin customer name and cnic.
		_('Name / CNIC') => array('fun'=>'name_cnic_link', 'ord' => '') ,
		//End - MUZZAMMIL - 20-Mar-2023
		_('Cust Order Ref'),
