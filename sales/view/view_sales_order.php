...
label_row(_('Customer'), $_SESSION['View']->customer_name, "class='tableheader2'",
	'colspan=3');
//Start - MUZZAMMIL - 08-03-2023
//Adding if Walk-In Customer then show customer_name and customer_cnic from sales_orders table
$sales_detail = get_sales_order_header($_GET['trans_no'], $_SESSION['View']->trans_type);
if($_SESSION['View']->customer_id == 1){
	label_row(_('Customer Name'), $sales_detail['cust_name'], "class='tableheader2'",
	'colspan=3');
	label_row(_('Customer CNIC'), $sales_detail['cust_cnic'], "class='tableheader2'",
	'colspan=3');
}
