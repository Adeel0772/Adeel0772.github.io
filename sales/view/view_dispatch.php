...
//new code
start_row();
label_cells(_('Charge To'), $myrow['DebtorName'] . '<br>' . nl2br($myrow['address']), "class='tableheader2'");
end_row();

if($myrow['DebtorName'] == 'Walk-In Customer'){
	start_row();
	label_cells(_('Name'), $sales_order['cust_name'], "class='tableheader2'");
	end_row();
	start_row();
	label_cells(_('CNIC'), $sales_order['cust_cnic'], "class='tableheader2'");
	end_row();
}
