...
function copy_to_cart() {
	...
	//Start - MUZZAMMIL - 03-03-2023
	//Added for customer name and cnic to be saved in the sales order.
	$cart->customer_name = $_POST['customer_name'];
	$cart->customer_cnic = $_POST['customer_cnic'];
	//End - MUZZAMMIL - 03-03-2023
...
function can_process() {
	...
	//Start - MUZZAMMIL - 08-03-2023
	//Added walkin customer name field required.
	if ($_SESSION['Items']->customer_name == null)	{
		display_error(_('Customer name is required.'));
		set_focus('customer_name');
		return false;
	}
	//End - MUZZAMMIL - 08-03-2023
...
function check_item_data() {
	...
	//Start - MUZZAMMIL - 16-Mar-2023
	//Removing the qty check for return/replace.
	...
	//Start - MUZZAMMIL - 16-Mar-2023
	//Removing the qty check for return/replace edit.
