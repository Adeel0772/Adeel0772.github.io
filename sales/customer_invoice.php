...
start_row();
$sales_detail = get_sales_order_header($_SESSION['Items']->order_no, 30);
if($_SESSION['Items']->customer_id == 1){
	label_cells(_('Customer Name'), $sales_detail['cust_name'], "class='tableheader2'");
	label_cells(_('Customer CNIC'), $sales_detail['cust_cnic'], "class='tableheader2'");
}
end_row();
